...
const Alerta = ({mensaje}) => {
  return (
    <div className=" text-center mt-4 p-4 mb-4 text-sm border-t-4 border-red-500 text-red-700 bg-red-100 rounded-lg dark:bg-red-200 dark:text-red-800" role="alert">
